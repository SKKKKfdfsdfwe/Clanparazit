document.addEventListener('DOMContentLoaded', () => {
  ...
  const extraOffset = 1800; // Например, 20 или -30
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Дополнительный сдвиг для прокрутки (можно менять)
  const extraOffset = 3550; // Например, 20 или -30
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Дополнительный сдвиг для прокрутки (можно менять)
  const extraOffset = 3000; // Например, 20 или -30
...
// создаём центральный светящийся курсор
...
document.addEventListener('mousemove', e => {
  ...
  // двигаем "звёздное ядро"
  core.style.left = x + 'px';
  core.style.top = y + 'px';

  // создаём "луч" — след за звездой
  const line = document.createElement('div');
  line.className = 'star-line';
  line.style.left = x + 'px';
  line.style.top = y + 'px';

  // добавляем случайный наклон для живости
